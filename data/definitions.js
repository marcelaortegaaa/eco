export default {
    ...
    "Dormir": [
        ...
        "4. Dicho de una cosa: Ser objeto de descuido, olvido o postergación.",
        "5. Dicho de lo que estaba inquieto o alterado: Sosegarse o apaciguarse. U. también c. prnl.",
        "6. Dicho de una peonza o de un trompo: Bailar con mucha rapidez, sin cabecear ni moverse de un sitio.",
        "7. En ciertos juegos de naipes, como el tresillo, dicho de una carta: Quedar en la baceta sin utilizar.",
        "8. Tomarse tiempo para meditar o discurrir sobre cosas que den en qué pensar. U. también c. prnl.",
        "9. Hacer que alguien se duerma.",
        "10. Dormir durante la siesta.",
        "11. Dormir tras una borrachera.",
        "12. Cuba y El Salv. Embaucar a alguien con el fin de obtener algún beneficio.",
        "13. Quedarse una persona o un animal dormidos.",
        "14. Dicho de un miembro del cuerpo: adormecerse (|| entumecerse).",
        "15. Mar. Dicho de la aguja de marear: Pararse y estar torpe en sus movimientos por debilidad de la imantación.",
    ...
    "Gota": [
        ...
        "4. Med. Enfermedad causada por la acumulación de cristales de ácido úrico en las articulaciones de las extremidades, en las que produce hinchazón muy dolorosa.",
    ...
    "Palma": [
        ...
        "4. Datilera.",
        "5. Palmito (|| planta).",
        "6. Parte inferior y algo cóncava de la mano, desde la muñeca hasta los dedos.",
        "7. Gloria, triunfo.",
        "8. Botambién Cada una de las plantas angiospermas monocotiledóneas, siempre verdes, de tallo leñoso, sin ramas, recto y coronado por un penacho de grandes hojas que se parten en lacinias y se renuevan anualmente, dejando sobre el tronco la base del pecíolo. Tienen flores axilares en espiga, generalmente dioicas y muy numerosas, y fruto en drupa o baya con una semilla; poco ej., la palmera, el cocotero y el palmito. U. t. en plural como taxón.",
    ...
    "Voto": [
        ...
        "4. Persona que da o puede dar su voto.",
        "5. Ruego o deprecación con que se pide a Dios una gracia.",
        "6. Juramento o execración en demostración de ira.",
